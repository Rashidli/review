                ...
                <div class="text-center mt-4">
                    <div class="mb-3">
                        <a href="{{route('home')}}" class="auth-logo">
                            <img style="width: 100px; height: 70px" src="{{asset('/')}}assets/images/57428360.png" height="30" class="logo-dark mx-auto" alt="">
                            <img style="width: 100px; height: 70px" src="{{asset('/')}}assets/images/57428360.png" height="30" class="logo-light mx-auto" alt="">
                        </a>
                    </div>
                </div>

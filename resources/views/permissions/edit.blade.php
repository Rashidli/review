                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('permissions.update',$permission->id)}}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" value="{{$permission->name}}" type="text" name="name" id="example-email-input">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" value="{{$permission->group_name}}" type="text" name="group_name" id="example-email-input">

                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="review_type" value="{{$order->review_type}}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <table class="repeater custom-table">
                                    ...
                                    @forelse($order->order_directions as $order_direction)
                                        <tr data-repeater-item>
                                                ...
                                                <div class="mb-3">
                                                    <select name="direction_car" class="form-control car_list">
                                                        ...
                                                        @foreach($direction_cars as $car)
                                                            <option value="{{$car->title}}" data-car_id="{{$car->id}}" {{$car->title == $order_direction->direction_car ? 'selected' : ''}}>{{$car->title}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-3">
                                                    <select name="direction_type" class="form-control direction_type">
                                                        ...
                                                        <option value="Bakı - Abşeron" {{$order_direction->direction_type == 'Bakı - Abşeron' ? 'selected' :''}} data-direction_type="1">Bakı - Abşeron</option>
                                                        <option value="Bakı - Region" {{$order_direction->direction_type == 'Bakı - Region' ? 'selected' :''}}  data-direction_type="2">Bakı - Region</option>
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-3">
                                                    <input type="number" class="form-control direction_price" name="direction_price" value="{{$order_direction->direction_price}}">
                                            ...
                                            <td>
                                                <div class="mb-3">
                                                    <input type="number" class="form-control direction_quantity" name="direction_quantity" value="{{$order_direction->direction_quantity}}">
                                                    @if($errors->first('direction_quantity')) <small class="form-text text-danger">{{$errors->first('direction_quantity')}}</small> @endif
                                                </div>
                                            </td>
                                            <td>
                                                <div class="mb-3">
                                                    <input type="number" class="form-control direction_total" name="direction_total" value="{{$order_direction->direction_total}}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <table class="repeater custom-table">
                                    ...
                                    @forelse($order->order_masters as $order_master)
                                        <tr data-repeater-item>
                                            <td>
                                                <div class="mb-3">
                                                    <select name="thing" class="form-control thing_list">
                                                        ...
                                                        @foreach($things as $thing)
                                                            <option {{$order_master->thing == $thing->title ? 'selected' : ''}} value="{{$thing->title}}" data-thing_id="{{$thing->id}}">{{$thing->title}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    <select name="thing_service" class="form-control thing_service_list">
                                                        ...
                                                        @foreach($thing_services as $thing_service)
                                                            <option {{$order_master->thing_service == $thing_service->title ? 'selected' : ''}} value="{{$thing_service->title}}" data-thing_service_id="{{$thing_service->id}}">{{$thing_service->title}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-3">
                                                    <input type="number" class="form-control thing_price" name="thing_price" value="{{$order_master->thing_price}}">
                                                    <div class="error-message" style="color: red"></div>
                                            ...
                                            <td>
                                                <div class="mb-3">
                                                    <input type="number" class="form-control thing_quantity" name="thing_quantity" value="{{$order_master->thing_quantity}}">
                                                    @if($errors->first('thing_quantity')) <small class="form-text text-danger">{{$errors->first('thing_quantity')}}</small> @endif
                                                </div>
                                            </td>
                                            <td>
                                                <div class="mb-3">
                                                    <input type="number" class="form-control thing_total" name="thing_total" value="{{$order_master->thing_total}}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <table class="repeater custom-table">
                                    ...
                                    @forelse($order->order_workers as $order_worker)
                                        <tr data-repeater-item>
                                            <td>
                                                <div class="mb-3">
                                                    <select name="worker" class="form-control worker_list">
                                                        ...
                                                        @foreach($workers as $worker)
                                                            <option {{$order_worker->worker == $worker->shift ? 'selected' : ''}} value="{{$worker->shift}}" data-worker_price="{{$worker->price}}">{{$worker->shift}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-3">
                                                    <input type="number" class="form-control worker_price" name="worker_price" value="{{$order_worker->worker_price}}">
                                                    <div class="error-message" style="color: red"></div>
                                            ...
                                            <td>
                                                <div class="mb-3">
                                                    <input type="number" class="form-control worker_quantity" name="worker_quantity" value="{{$order_worker->worker_quantity}}">
                                                    @if($errors->first('worker_quantity')) <small class="form-text text-danger">{{$errors->first('worker_quantity')}}</small> @endif
                                                </div>
                                            </td>
                                            <td>
                                                <div class="mb-3">
                                                    <input type="number" class="form-control worker_total" name="worker_total" value="{{$order_worker->worker_total}}">
...
<script>
    $(document).ready(function () {
        ...
        function handleRegionChange() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    directionSelect.select2(); // Initialize or update the Select2

                    // Adjust the width of the Select2 for direction_list
                    var directionContainer = directionSelect.siblings('.select2-container');
                    directionContainer.css('width', ''); // Reset width
        ...
        $(document).on('change', '.direction_type', handleRegionChange);
        ...
        function calculateRegionPrice(element) {
            ...
            // Validate minimum value for direction_price
        ...
        $(document).on('input', '.direction_list, .car_list', function (e) {
            getRegionPrice($(this));
        });
        ...
        function getThingPrice(element) {
            ...
            console.log(thing_id,thing_service_id);
            $.ajax({
                type: 'POST',
                url: '/getThingPrice',

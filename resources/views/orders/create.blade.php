                ...
                <form action="{{route('orders.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input required class="form-control" type="text"  name="customer_name" value="{{old('customer_name')}}">
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input required class="form-control" type="date"  name="review_date" value="{{old('review_date')}}">
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input required x-model="phone" x-on:change="applyMask()" class="form-control" type="text"  name="phone">
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input required x-model="operator_phone" x-on:change="applyMask()" class="form-control" type="text"  name="operator_phone">
                            ...
                            <div class="row" x-data="direction()">
                                <div class="col-12">
                                    <h4>Nəqliyyat</h4>
                                    <table class="custom-table">
                                        <thead>
                                        ...
                                        <template x-for="(field, index) in fields" :key="index">
                                            <tr>
                                                <td>
                                                    <div class="mb-3">
                                                        <select x-model="field.direction_car"  @change="updatePrice(field)" name="direction_car[]" class="form-control car_list">
                                                            <option >----</option>
                                                ...
                                                <td :style="field.direction_type !== 'Region - Region' ? '' : 'display: none;'">
                                                    <div class="mb-3">
                                                        <select id="direction" x-model="field.direction" name="direction[]" @change="updatePrice(field)" class="form-control direction_list">
                                                            <option x-text="'Select Direction'" :value="''" :="true"></option>
                                                            <template x-for="direction in field.direction_list">
                                                                <option x-text="direction.title" :value="direction.title" :data-direction_id="direction.id"></option>
                                                            </template>
                                                        </select>
                                                ...
                                                <td>
                                                    <div class="mb-3">
                                                        <input required type="number" @keyup="calcCommon(field)" x-model="field.direction_price" name="direction_price[]" class="form-control direction_price" value="">
                                                ...
                                                <td>
                                                    <div class="mb-3">
                                                        <input  required type="number" @keyup="calcCommon(field)" class="form-control direction_quantity" x-model="field.direction_quantity" name="direction_quantity[]" value="">
                                                ...
                                                <td>
                                                    <div class="mb-3">
                                                        <input required type="number" @keyup="calcCommon(field)" class="form-control" x-model="field.direction_worker_total" name="direction_worker_total[]" value="">
                                                ...
                                                <td>
                                                    <div class="mb-3">
                                                        <input required type="number" @keyup="calcCommon(field)" class="form-control" x-model="field.direction_worker_price" name="direction_worker_price[]" value="">
                                                ...
                                                <td>
                                                    <div class="mb-3">
                                                        <input required type="number" class="form-control direction_total" x-model="field.direction_total" name="direction_total[]" value="" readonly>
                                        ...
                                        <tbody>
                                            <template x-for="(field, index) in fields" :key="index">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="mb-3">
                                                            <input required type="number" class="form-control thing_price" x-model="field.thing_price" @keyup="calcCommon(field)" name="thing_price[]"  value="">
                                                            <div class="error-message" style="color: red"></div>
                                                    ...
                                                    <td>
                                                        <div class="mb-3">
                                                            <input required type="number" class="form-control thing_quantity" @keyup="calcCommon(field)"  x-model="field.thing_quantity" name="thing_quantity[]" value="">
                                                            @if($errors->first('thing_quantity')) <small class="form-text text-danger">{{$errors->first('thing_quantity')}}</small> @endif
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="mb-3">
                                                            <input required type="number" class="form-control thing_total"  x-model="field.thing_total" name="thing_total[]" readonly value="">
                                        ...
                                        <tbody>
                                            <template x-for="(field, index) in fields" :key="index">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="mb-3">
                                                            <input required type="number" class="form-control worker_price" x-model="field.worker_price" @input="calcCommon(field)" name="worker_price[]" value="">
                                                            <div class="error-message" style="color: red"></div>
                                                    ...
                                                    <td>
                                                        <div class="mb-3">
                                                            <input required type="number" class="form-control worker_quantity" x-model="field.worker_quantity" @input="calcCommon(field)" name="worker_quantity[]" value="">
                                                            @if($errors->first('worker_quantity')) <small class="form-text text-danger">{{$errors->first('worker_quantity')}}</small> @endif
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="mb-3">
                                                            <input required type="number" class="form-control worker_day" x-model="field.worker_day" @input="calcCommon(field)" name="worker_day[]" value="1">
                                                            @if($errors->first('worker_day')) <small class="form-text text-danger">{{$errors->first('worker_day')}}</small> @endif
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="mb-3">
                                                            <input required type="number" class="form-control worker_total" x-model="field.worker_total" name="worker_total[]" value="" readonly>
...
<script>
    ...
    function applyMask() {
        ...
        operatorInput.value = '994' + operatorInput.value.replace(/\D/g, '');
    ...
    function direction() {
        return {
            ...
            updatePrice(field) {
                ...
                if (field.direction_car === '----' && field.direction_type === '----') {
                    field.direction_car = null;
                    field.direction_type = null;
                }

                if (field.direction === 'Select Direction') {
                    field.direction = null;
                }
                if (field.direction_type !== 'Region - Region') {
                    field.from = null;
                    field.to = null;
                } else {
                    field.direction = null;
                ...
                if (selectedCarId && selectedDirectionType && selectedDirection) {
                    $.ajax({
